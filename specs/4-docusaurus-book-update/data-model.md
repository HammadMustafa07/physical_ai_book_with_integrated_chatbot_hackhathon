...
- url: "/" (required, string)
- navigation: [Physical AI And Humanoid Robotics, Book] (required, array of navigation items)
...
### Navigation Bar
**Description**: The top navigation that contains only essential links (Physical AI And Humanoid Robotics, Book)
**Fields**:
...
- Items must be "Physical AI And Humanoid Robotics" and "Book"
...
**Validation Rules**:
- Label must be one of: "Physical AI And Humanoid Robotics", "Book"
...
- number: integer (required, 1-4)

**Validation Rules**:
- Must have exactly 4 modules
- Each module number must be 1, 2, 3, or 4
...
### Module4Content
**Description**: The content that will be restructured into Module 4 from existing VLA content
**Fields**:
- source: "vla" (required, string)
- chapters: [Chapter] (required, array of 3 chapters)
- destination: "Module 4" (required, string)

**Validation Rules**:
- Must be restructured from existing VLA content
- Must contain exactly 3 chapters
- Must follow Module 4 naming convention